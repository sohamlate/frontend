...
const ResetPass = ()=>{
    ...
    const submitHandler= async(e)=>{
      ...
      try {
        ...
        const response = await axios.post('https://backend-1-9nhi.onrender.com/api/v1/auth/resetPasswordToken', formDataWithtoken);
    ...
    return (
        <div className="flex flex-col w-[27%] mt-5 h-[25rem] ml-[40%] border-[0.2rem] bg-white rounded-md text-md pb-[18%] px-[1rem]">
